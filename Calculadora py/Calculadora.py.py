...
boton_multiplicación = Button(ventana, text = "*", width = 5, height = 2, command = lambda: click_boton("*"))
...
boton_igual = Button(ventana, text = "=", width = 5, height = 2, command = lambda: Resolución())
...
boton_multiplicación.grid(row = 2, column = 3, padx = 5, pady = 5)
...
boton_punto.grid(row = 5, column = 2, columnspan = 2, padx = 5, pady = 5)
boton_igual.grid(row = 5, column = 3, columnspan = 2, padx = 5, pady = 5)
